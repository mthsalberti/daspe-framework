    ...
    class FilterBrowseControl{
        ...
        listenToFilterBrowseButton(){
            ...
            $('.modal-filter').off('click').on('click', function () {
                $.ajax({
                    type: 'GET',
                    url: '/admin/filter-control/get-options/'+'{{\Daspeweb\Framework\DaspewebHelper::slug()}}',
                ...
                if(label == 'confirmar'){
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            dw_model_id: "{{@\Daspeweb\Framework\DaspewebHelper::info()->id}}"
                        },
                        ...
                        success: function (output, status, xhr) {
                            let currentFilters = JSON.parse(localStorage.getItem("filter-{{\Daspeweb\Framework\DaspewebHelper::slug()}}"));
                            let spinnerC = new SpinnerController();
                            ...
                            localStorage.setItem("filter-{{\Daspeweb\Framework\DaspewebHelper::slug()}}", []);
                        }
                    });
                }else{
                    let ele = `
        ...
        loadFilterBrowse(){
            let self = this;
            let currentRaw = localStorage.getItem("filter-{{\Daspeweb\Framework\DaspewebHelper::slug()}}");
        ...
        saveFilterLocalStorage(){
            let slug = "{{\Daspeweb\Framework\DaspewebHelper::slug()}}";
            let objAux = [];
            ...
            localStorage.setItem("filter-{{\Daspeweb\Framework\DaspewebHelper::slug()}}", JSON.stringify(objAux));
        }
    }
</script>
